...
function buildMain(page) {
  ...
  <div class="coming-shell">
    ...
    <section class="coming-note" aria-labelledby="coming-note-title">
      <span class="coming-meta-label">What To Expect</span>
      <h2 id="coming-note-title">The route is fixed. The release is scheduled.</h2>
      <div class="coming-note-grid">
        <article>
          <h3>Real HTML shell</h3>
          <p>This page now uses the existing live-site structure instead of the Astro shell that caused the mismatch.</p>
        </article>
        <article>
          <h3>URL preserved</h3>
          <p>The route remains active so sitemap, feed, and internal links can keep pointing to the same address.</p>
        </article>
        <article>
          <h3>Timed release</h3>
          <p>The countdown targets 20 July 2026 and updates live in the browser without extra libraries.</p>
        </article>
      </div>
    </section>
  </div>
